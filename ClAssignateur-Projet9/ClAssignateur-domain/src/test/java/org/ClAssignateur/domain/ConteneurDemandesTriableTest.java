...
public class ConteneurDemandesTriableTest {
	...
	// @Test
	// public void
	// lorsqueOnAjouteUneDemandeAConteneurDemandeTriableIlNestPlusVide() {
	// conteneurDemandeTriable.ajouterDemande(DEMANDE);
	//
	// boolean fileEstVide = conteneurDemandeTriable.estVide();
	//
	...
	// @Test
	// public void
	// lorsqueOnAjouteUneDemandeAConteneurDemandeTriableSaTailleAugmenteDeUn() {
	// // int tailleInitiale = conteneurDemandeTriable.taille();
	// //
	...
	// @Test
	// public void
	// lorsqueOnAjouteUnElementEtQuOnLEnleveConteneurDemandeTriableDevientVide()
	// throws Throwable {
	// conteneurDemandeTriable.ajouterDemande(DEMANDE);
	//
	...
	// @Test
	// public void
	// lorsqueOnEnleveDesElementsLePremierArriveEstLePremierSortiPourUneMemePriorite()
	// {
	// ConteneurDemandesTriable fileDemandeTroisElement = new
	// ConteneurDemandesTriable();
	// configurationDesDemande();
	// fileDemandeTroisElement.ajouterDemande(DEMANDE);
	// fileDemandeTroisElement.ajouterDemande(DEMANDE_2);
	// fileDemandeTroisElement.ajouterDemande(DEMANDE_3);
	//
	...
	//
	// @Test
	// public void fileDemandePrioriseLesDemandesPlusPrioritaire() throws
	// Throwable {
	// ConteneurDemandesTriable fileDemandeTroisElement = new
	// ConteneurDemandesTriable();
	// configurationDesDemandeAvecPriorite();
	// fileDemandeTroisElement.ajouterDemande(DEMANDE_PRIORITE_FAIBLE);
	// fileDemandeTroisElement.ajouterDemande(DEMANDE_PRIORITE_MOYENNE);
	// fileDemandeTroisElement.ajouterDemande(DEMANDE_PRIORITE_FORTE);
	//
	// Demande premierElementEnlever = fileDemandeTroisElement.retirer();
	// Demande deuxiemeElementEnlever = fileDemandeTroisElement.retirer();
	// Demande troisiemeElementEnlever = fileDemandeTroisElement.retirer();
	...
	// Date deuxiemeTemps = new Date(2010, 1, 1, 1, 2, 0);
	// Date troisiemeTemps = new Date(2010, 1, 1, 1, 3, 0);
	// willReturn(premierTemps).given(DEMANDE_PRIORITE_FAIBLE).getMomentDeCreation();
	// willReturn(deuxiemeTemps).given(DEMANDE_PRIORITE_MOYENNE).getMomentDeCreation();
	// willReturn(troisiemeTemps).given(DEMANDE_PRIORITE_FORTE).getMomentDeCreation();
	// willReturn(PRIORITE_FAIBLE).given(DEMANDE_PRIORITE_FAIBLE).getPriorite();
	// willReturn(PRIORITE_MOYENNE).given(DEMANDE_PRIORITE_MOYENNE).getPriorite();
